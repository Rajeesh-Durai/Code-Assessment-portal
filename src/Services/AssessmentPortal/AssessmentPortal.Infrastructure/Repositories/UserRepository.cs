...
namespace AssessmentPortal.Infrastructure.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        private const string GetUserByEmailStoredProcedure = "SkillAssessmentRead.GetUserById";
        ...
        public async Task<User> GetUserByEmailAsync(string email)
        {
            ...
            return await ExecuteStoredProcedureAsync(GetUserByEmailStoredProcedure, parameters);
        }
